...
__conda_setup="$('/mnt/h/code/anaconda2/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/mnt/h/code/anaconda2/etc/profile.d/conda.sh" ]; then
        . "/mnt/h/code/anaconda2/etc/profile.d/conda.sh"
    else
        export PATH="/mnt/h/code/anaconda2/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
